...
- Setup Eloquent to use SQLite
- <code>models</code> directory for storing model classes
- Updated <code>composer.json</code> classmap to load the Models DIR
- <code>tests</code> directory
- Updated <code>composer.json</code> to include PHPSpec for testing
